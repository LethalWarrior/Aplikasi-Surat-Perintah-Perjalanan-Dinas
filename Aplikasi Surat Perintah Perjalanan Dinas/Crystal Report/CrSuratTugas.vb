...
Public Class CrSuratTugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Surat_Perintah_Perjalanan_Dinas.CrSuratTugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSuratTugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSuratTugas = New CrSuratTugas
        rpt.Site = Me.Site
        Return rpt
    End Function
