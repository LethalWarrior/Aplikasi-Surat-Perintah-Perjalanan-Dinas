...
Public Class FrEntriDataPenyelenggara
    Private EProf As New ErrorProvider
    'Private Ctrl As CtrlForm
    Friend CtrlPY As New CtrlPenyelenggara(Me)
    ...
    Private Sub FrEntriDataPenyelenggara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        StateAwal()
    End Sub
    ...
    Private Sub StateInput()
        Ctrl.EnableControls(False)
        Ctrl.EnableControls(True, New Control() {BtnSimpan, BtnBatal, BtnKeluar, TbxNamaPenyelenggara, TbxAlamat, TbxTlp})
        BtnSimpan.Text = "SIMPAN"
        If (Edit = False) Then
            TbxKodePenyelenggara.Text = CtrlPY.GetAutoNumber()
        End If
    End Sub
    ...
    Private Sub FrEntriDataPenyelenggara_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
